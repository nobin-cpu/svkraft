    ...
    return SafeArea(
      child: Scaffold(
        body: SingleChildScrollView(
            child: cartData != null
                ? cartData.grocery.length > 0 || cartData.special_day.length > 0
                    ? Column(
                                                              ...
                                                              children: [
                                                                ...
                                                                Text(
                                                                  "price".tr +
                                                                      arabicNumber
                                                                          .convert(
                                                                              singlespecial_dayPrice.toString()) +
                                                                      "kr".tr,
                                                                  style: const TextStyle(
                                                                      fontSize:
                                                                          16,
                    ...
                    : Center(child: Text('No Product Found'.tr))
                : SizedBox()),
