                              ...
                              child: Container(
                                ...
                                child: CarouselSlider.builder(
                                  ...
                                  options: CarouselOptions(
                                    ...
                                    autoPlay:
                                        snapshot.data[0]['image'].length > 1
                                            ? true
                                            : false,
                                    aspectRatio: 16 / 10,
                                      ...
                                      sellerId:
                                          snapshot.data[0]["seller_id"] != null
                                              ? snapshot.data[0]["seller_id"]
                                                  .toString()
                                              : "0",
                                      sellerImage: snapshot.data[0]
                                                  ["seller_image"] !=
                                              null
                                          ? snapshot.data[0]["seller_image"]
                                          : "",
                                      sellerName: snapshot.data[0]
                                                  ["seller_name"] !=
                                              null
                                          ? snapshot.data[0]["seller_name"]
                                          : "",
                                      sellerNumber: snapshot.data[0]
                                                  ["seller_phone"] !=
                                              null
                                          ? snapshot.data[0]["seller_phone"]
                                          : "",
                                      email: snapshot.data[0]["seller_email"] !=
                                              null
                                          ? snapshot.data[0]["seller_email"]
                                          : "",
                                    ));
