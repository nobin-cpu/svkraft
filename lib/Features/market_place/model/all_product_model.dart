...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        image: json["image"] == null
            ? null
            : List<Images>.from(json["image"].map((x) => Images.fromJson(x))),
      );
  ...
  @override
  String toString() {
    return 'Datum{id:$id,category_id:$categoryId,category_name: $categoryName,product_name: $productName,description:$description,price:$price,adsType:$adsType,gearbox:$gearbox,model:$model,milage:$milage,cartType:$cartType,fuel:$fuel,location:$location,is_bookmark:$isBookmark,image:$image}';
  }
}
